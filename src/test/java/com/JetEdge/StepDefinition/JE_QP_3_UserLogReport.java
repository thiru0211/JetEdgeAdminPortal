...
public class JE_QP_3_UserLogReport {
	...
	public void select_valid_from_date_in_login_report() {
		...
		ele3.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.id("CalendarExtender1_day_0_1")));
		ele4 = driver.findElement(By.id("CalendarExtender1_day_0_1"));
		ele4.click();
	...
	public void click_expand_button_in_crew_login() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/form/div[3]/table[3]/tbody/tr[2]/td/div/table/tbody/tr[2]/td[1]/a/img")));
	...
	public void click_expand_button_in_login_report() {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(2));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/form/div[3]/table[3]/tbody/tr[2]/td/div/table/tbody/tr[2]/td[1]")));
		ele1 = driver
				.findElement(By.xpath("/html/body/form/div[3]/table[3]/tbody/tr[2]/td/div/table/tbody/tr[2]/td[1]"));
		ele1.click();
		driver.switchTo().defaultContent();
	}
}
